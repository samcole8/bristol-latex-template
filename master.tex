...
% bibliography
\usepackage[backend=biber, style=authoryear-ibid, giveninits=true, maxnames=3, minnames=1, uniquename=false]{biblatex}
...
\begin{titlepage}
  ...
  \vspace{0.3in}
  \vfill
  {\large Submitted to the School of [Department Name]} \\
  \vspace{0.2in}
